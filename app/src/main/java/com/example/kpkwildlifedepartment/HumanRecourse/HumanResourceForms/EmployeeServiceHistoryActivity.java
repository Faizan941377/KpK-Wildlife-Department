...
public class EmployeeServiceHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_service_history);


        bpsSP = findViewById(R.id.sp_EmployeeService_BPS);

        EmployeeServiceHistoryBPS();
    }

    private void EmployeeServiceHistoryBPS() {
        ...
        bpsSP.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(EmployeeServiceHistoryActivity.this, "Please Select your BPS!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}